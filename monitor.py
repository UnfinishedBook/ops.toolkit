...
if len(sys.argv)==4 and (sys.argv[1]=='qb' or sys.argv[1]=='db') and (sys.argv[2]=='job' or sys.argv[2]=='queue') and sys.argv[3]=='--discover':
    pass
elif len(sys.argv)==3 and (sys.argv[1]=='qb' or sys.argv[1]=='db') and sys.argv[2]=='--up':
    pass
else:
    print '''usage:
